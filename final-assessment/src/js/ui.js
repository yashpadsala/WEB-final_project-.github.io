...
function toggleLoading(isLoading) {
  ...
  //var but = document.querySelector('#form');
  var newButton = document.getElementById("form");


  if(isLoading)
  {
    newButton.setAttribute("disabled","disabled");
    newButton.innerHTML = '<i class="fas fa-hourglass-half"></i> Loading...'
  }
  else{
    newButton.removeAttribute("disabled");
    newButton.innerHTML = '<i class="fas fa-search"></i> Search'
  }
